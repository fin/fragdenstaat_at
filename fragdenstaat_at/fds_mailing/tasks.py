...
@celery_app.task(name="fragdenstaat_at.fds_mailing.send_mailing")
...
@celery_app.task(name="fragdenstaat_at.fds_mailing.continue_sending")
...
@celery_app.task(name="fragdenstaat_at.fds_mailing.process_pixel_log")
