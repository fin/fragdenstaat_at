    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.FILINGCABINET_DOCUMENT_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_annotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='filingcabinet.PageAnnotation')),
            ],
            options={
                'abstract': False,
            },
