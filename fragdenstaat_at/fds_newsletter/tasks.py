...
@celery_app.task(name="fragdenstaat_at.fds_newsletter.cleanup_subscribers")
def cleanup_subscribers_task():
    cleanup_subscribers()


@celery_app.task(name="fragdenstaat_at.fds_newsletter.cleanup_feedback")
def cleanup_feedback_task():
    cleanup_feedback()


@celery_app.task(name="fragdenstaat_at.fds_newsletter.gather_subscriber_tags")
...
@celery_app.task(name="fragdenstaat_at.fds_newsletter.run_subscriber_import")
